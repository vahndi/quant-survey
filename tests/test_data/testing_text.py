...
LI_EUROPAN_LINGUES = (
    ...
    ' simplic quam Occidental in fact, it va esser Occidental. A un Angleso it'
    ' va semblar un simplificat Angles, quam un skeptic Cambridge amico dit me'
    ' que Occidental es.Li Europan lingues es membres del sam familie. Lor'
    ' separat existentie es un myth. Por scientie, musica, sport etc, litot'
    ' Europa usa li sam vocabular. Li lingues differe solmen in li grammatica,'
    ' li pronunciation e li plu commun vocabules. Omnicos directe al '
...
LI_EUROPAN_LINGUES_EN = (
    ...
    'science, music, sport, etc, Europe uses the same vocabulary. The languages'
    ' only differ in their grammar, their pronunciation and their most common '
    'words. Everyone realizes why a new common language would be desirable: one'
    ' could refuse to pay expensive translators. To'
)
FAR_FAR_AWAY = (
    ...
    'decided to leave for the far World of Grammar. The Big Oxmox advised her '
    'not to do so, because there were thousands of bad Commas, wild Question '
    'Marks and devious Semikoli, but the Little Blind Text didn’t listen. She '
    'packed her seven versalia, put her initial into the belt and made herself '
...
WERTHER = (
    ...
    'strikes the upper surface of the impenetrable foliage of my trees, and but'
    ' a few stray gleams steal into the inner sanctuary, I throw myself down '
    'among the tall grass by the trickling stream; and, as I lie close to the '
    'earth, a thousand unknown plants are noticed by me: when I hear the buzz '
    'of the little world among the stalks, and grow familiar with the countless'
...
PANGRAM = (
    ...
    'quack. Quick wafting zephyrs vex bold Jim. Quick zephyrs blow, vexing daft'
    ...
    'woven flax jodhpurs! "Now fax quiz Jack!" my brave ghost pled. Five '
    'quacking zephyrs jolt my wax bed. Flummoxed by job, kvetching W. zaps '
    'Iraq. Cozy sphinx waves quart jug of bad milk. A very bad quack might jinx'
    ' zippy fowls. Few quips galvanized the mock jury box. Quick brown dogs '
    'jump over the lazy fox. The jay, pig, fox, zebra, and my wolves quack! '
    'Blowzy red vixens fight for a quick jump. Joaquin Phoenix was gazed by MTV'
    ' for luck. A wizard’s job is to vex chumps quickly in fog. Watch '
    '"Jeopardy!", Alex Trebek’s fun TV quiz game. Woven silk pyjamas exchanged '
    'for blue quartz. Brawny gods just'
)
